...
import blogimg7 from '../../../assets/images/blog/blog14.jpg';
import blogimg8 from '../../../assets/images/blog/blog15.jpg';
// author img
        ...
        return (
            <section className="section-padding bg-gray our-articles">
                <div className="container">
                    <div className="row">
                        {blogpost.map((item, i) => (
                            <article key={i} className="col-lg-4 col-md-6 post mb-xl-30">
